package com.example.myapplication.presentation.uii.screens.about
...
import com.example.myapplication.presentation.uii.screens.about.components.AboutInfoRow
...
fun AboutScreen(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(text = "Idea Generator", fontSize = AppDimensions.fontDisplay, fontWeight = FontWeight.Bold, textAlign = TextAlign.Center)
